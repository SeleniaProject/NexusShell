...
fn test_user_defined_functions() {
    ...
    let result = executor.call_user_function_by_name("factorial", factorial_args).unwrap();
    assert_eq!(result, MirValue::Integer(120));
    
    // Test fibonacci function  
    let fib_args = vec![MirValue::Integer(10)];
    let result = executor.call_user_function_by_name("fibonacci", fib_args).unwrap();
    ...
    let result = executor.call_user_function_by_name("max", max_args).unwrap();
    ...
    let result = executor.call_user_function_by_name("sum", sum_args).unwrap();
...
fn test_higher_order_functions() {
    ...
    let result = executor.call_user_function_by_name("map", map_args).unwrap();
    ...
    let result = executor.call_user_function_by_name("filter", filter_args).unwrap();
    ...
    let result = executor.call_user_function_by_name("reduce", reduce_args).unwrap();
    assert_eq!(result, MirValue::Integer(10));
...
fn test_performance_optimized_functions() {
    ...
    let result = executor.call_user_function_by_name("reduce", sum_args).unwrap();
