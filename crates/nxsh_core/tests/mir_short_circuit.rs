...
fn and_short_circuits() {
    ...
    let assign_a = AstNode::VariableAssignment { name: "a", operator: AssignmentOperator::Assign, value: Box::new(AstNode::NumberLiteral { value: "0", number_type: NumberType::Decimal }), is_local:false,is_export:false,is_readonly:false};
    // (0 == 1) && (1 / 0 == 0)  -- right would panic if evaluated; expect false
    let left_cmp = AstNode::BinaryExpression { left: Box::new(AstNode::NumberLiteral { value: "0", number_type: NumberType::Decimal }), operator: BinaryOperator::Equal, right: Box::new(AstNode::NumberLiteral { value: "1", number_type: NumberType::Decimal }) };
    let div = AstNode::BinaryExpression { left: Box::new(AstNode::NumberLiteral { value: "1", number_type: NumberType::Decimal }), operator: BinaryOperator::Divide, right: Box::new(AstNode::NumberLiteral { value: "0", number_type: NumberType::Decimal }) };
...
fn or_short_circuits() {
    ...
    let left_true = AstNode::BinaryExpression { left: Box::new(AstNode::NumberLiteral { value: "1", number_type: NumberType::Decimal }), operator: BinaryOperator::Equal, right: Box::new(AstNode::NumberLiteral { value: "1", number_type: NumberType::Decimal }) };
    let div = AstNode::BinaryExpression { left: Box::new(AstNode::NumberLiteral { value: "1", number_type: NumberType::Decimal }), operator: BinaryOperator::Divide, right: Box::new(AstNode::NumberLiteral { value: "0", number_type: NumberType::Decimal }) };
    let right_cmp = AstNode::BinaryExpression { left: Box::new(div), operator: BinaryOperator::Equal, right: Box::new(AstNode::NumberLiteral { value: "2", number_type: NumberType::Decimal }) };
    let or_expr = AstNode::BinaryExpression { left: Box::new(left_true), operator: BinaryOperator::LogicalOr, right: Box::new(right_cmp) };
    let closure = AstNode::Closure { params: vec![], body: Box::new(AstNode::Return(Some(Box::new(or_expr)))), captures: vec![], is_async: false };
